  ...
  setInterval(currentTime, 1000);
    ...
    //display the new descriptionbox!
    const descriptionBox = document.getElementById("hear-about");
    const infoBox = document.getElementById("info-box");

    // Show info box when focused
    descriptionBox.addEventListener("focus", function () {
        infoBox.style.display = "block";
    });

    // Keep info box visible if there's content when losing focus
    descriptionBox.addEventListener("blur", function () {
